...
interface IPsxResources {
  ...
  /**
   * {@link MingleM5LifecycleManager}.
   */
  String FMT_WARN_NO_ORIG_MEDIA_DIR    = Messages.getString( "FMT_WARN_NO_ORIG_MEDIA_DIR" );    //$NON-NLS-1$
  String FMT_WARN_EPISODE_OF_SAME_DATE = Messages.getString( "FMT_WARN_EPISODE_OF_SAME_DATE" ); //$NON-NLS-1$
