...
public class SvinM5Mpc
  ...
  static final ITsActionDef AI_SHOW_ALL_SVINS_IN_FRAMES_LIST = TsActionDef.ofPush2( AID_SHOW_ALL_SVINS_IN_FRAMES_LIST,
      STR_N_SHOW_ALL_SVINS_IN_FRAMES_LIST, STR_D_SHOW_ALL_SVINS_IN_FRAMES_LIST, ICONID_FRAMES_PER_SVIN_FORCE_ONE );
  ...
  public SvinM5Mpc( ITsGuiContext aContext, IM5Model<Svin> aModel, IM5ItemsProvider<Svin> aItemsProvider,
    ...
    IMultiPaneComponentConstants.OPDEF_DBLCLICK_ACTION_ID.setValue( tsContext().params(), avStr( ACTID_PLAY ) );
  ...
  protected ITsToolbar doCreateToolbar( ITsGuiContext aContext, String aName, EIconSize aIconSize,
    ...
    aActs.add( new TsActionDef( ACDEF_PLAY_MENU ) );
    aActs.add( ACDEF_SEPARATOR );
  ...
  protected void doProcessAction( String aActionId ) {
    switch( aActionId ) {
      ...
      case ACTID_PLAY: {
        ...
        if( sel != null ) {
          psxService().playEpisodeVideo( sel );
        }
        break;
      }
      default:
