...
import static com.hazard157.prisex24.m5.tags.IPsxResource.*;
...
public class TagM5Model
  ...
  /**
   * {@link IAvMetaConstants#DDEF_DESCRIPTION} (он же {@link ITag#description()}).
   */
  ...
  /**
   * {@link ITagsConstants#IS_MANDATORY}.
   */
  ...
  /**
   * {@link ITagsConstants#IN_RADIO_PRIORITY}
   */
   ...
   */
  public TagM5Model() {
    super( MID_TAG, ITag.class );
    setNameAndDescription( STR_TAG, STR_TAG_D );
    ID.setNameAndDescription( STR_TAG_ID, STR_TAG_ID_D );
    ...
    NAME.setNameAndDescription( STR_TAG_NAME, STR_TAG_NAME_D );
    ...
    addFieldDefs( ID, NAME, DESCRIPTION, IS_LEAF, IS_MANDATORY, IS_RADIO,
        // ICON_NAME,
        IN_RADIO_PRIORITY );
    setPanelCreator( new M5DefaultPanelCreator<ITag>() {
      ...
      protected IM5CollectionPanel<ITag> doCreateCollChecksPanel( ITsGuiContext aContext,
        ...
        TreeModeInfo<ITag> tmi1 = new TreeModeInfo<>( "ByGroup", //$NON-NLS-1$
            STR_TMI_BY_GROUP, STR_TMI_BY_GROUP_D, ICONID_TAGS_LIST, new TreeMakerByGroups( rootTag ) );
