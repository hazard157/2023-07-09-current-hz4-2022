...
interface IPsxCofsInternalConstants {
  ...
  File COFS_MINGLES_ROOT  = new File( COFS_ROOT, "inc-mingles/" ); //$NON-NLS-1$
  ...
  String SUBDIR_GAZE_SOURCE = "srcmedia"; //$NON-NLS-1$
  String SUBDIR_GAZE_OUTPUT = "output";   //$NON-NLS-1$

  String SUBDIR_MINGLE_SOURCE = "srcmedia"; //$NON-NLS-1$
  String SUBDIR_MINGLE_OUTPUT = "output";   //$NON-NLS-1$
