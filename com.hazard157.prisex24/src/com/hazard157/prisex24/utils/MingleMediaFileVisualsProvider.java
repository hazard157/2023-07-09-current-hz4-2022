...
public class MingleMediaFileVisualsProvider
   ...
   */
  public MingleMediaFileVisualsProvider( ITsGuiContext aWinContext ) {
  ...
  private TsImage getAudioThumb( EThumbSize aThumbSize ) {
    ...
    if( mi == null ) {
      mi = makeMi( ICONID_AUDIO_X_GENERIC, aThumbSize );
  ...
  private TsImage getTextThumb( EThumbSize aThumbSize ) {
    ...
    if( mi == null ) {
      mi = makeMi( ICONID_TEXT_X_GENERIC, aThumbSize );
  ...
  private TsImage getUnknwonThumb( EThumbSize aThumbSize ) {
    ...
    if( mi == null ) {
      mi = makeMi( ICONID_UNKNOWN_X_GENERIC, aThumbSize );
  ...
  public TsImage getThumb( OptedFile aEntity, EThumbSize aThumbSize ) {
    ...
    if( IMediaFileConstants.VIDEO_FILE_EXT_LIST.hasElem( ext ) ) {
      File illustrationFile = psxCofs().ensureSummaryImage( aEntity );
