...
interface IHzResources {
  ...
  String STR_MINGLE_ID_MUST_BE           = IPrisexIncidentConstants.MINGLE_ID_PREFIX + "ГГГГ_ММ_ДД";
  ...
  String FMT_ERR_INV_MINGLE_ID_INV_START =
      "Mingle ID '%s' must start with char '" + IPrisexIncidentConstants.MINGLE_ID_PREFIX;
