...
interface IHzResources {
  ...
  String STR_GAZE_ID_MUST_BE           = IPrisexIncidentConstants.GAZE_ID_PREFIX + "ГГГГ_ММ_ДД";
  ...
  String FMT_ERR_INV_GAZE_ID_INV_START =
      "Gaze ID '%s' must start with char '" + IPrisexIncidentConstants.GAZE_ID_PREFIX;
