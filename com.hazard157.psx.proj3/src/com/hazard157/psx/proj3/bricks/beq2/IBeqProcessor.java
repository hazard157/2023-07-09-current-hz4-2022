package com.hazard157.psx.proj3.bricks.beq2;
...
public interface IBeqProcessor {
   ...
   * @return {@link ISvinSeqEdit} - created instance of result
   * @throws TsNullArgumentRtException any argument = <code>null</code>
   * @throws TsItemNotFoundRtException unknown filter in given parameters
   */
  ISvinSeqEdit queryData( ITsCombiFilterParams aFilterParams );
