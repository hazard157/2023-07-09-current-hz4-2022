...
public class PlepM5Model
  ...
  public static final M5AttributeFieldDef<IPlep> STIRS_COUNT =
      new M5AttributeFieldDef<>( IPlepM5Constants.FID_STIRS_COUNT, EAtomicType.INTEGER, //
   ...
   */
  public static final M5AttributeFieldDef<IPlep> PLACE =
      new M5AttributeFieldDef<>( IPlepM5Constants.FID_PLACE, DDEF_STRING ) {
  ...
  public final IM5MultiModownFieldDef<IPlep, String> PREP_STEPS =
      new M5MultiModownFieldDef<>( IPlepM5Constants.FID_PREP_STEPS, StringM5Model.MODEL_ID ) {
   ...
   */
  public PlepM5Model() {
    super( IPlepM5Constants.MID_PLEP, IPlep.class );
