...
interface ITsResources {
  ...
  String STR_N_IS_LABEL2_SHOWN        = "Подпись 2?";
  String STR_D_IS_LABEL2_SHOWN        = "Признак показа втрой строки подписи под изображение";
  ...
  String STR_N_SELECTION_BORDER_COLOR = "Цвет выделения";
  String STR_D_SELECTION_BORDER_COLOR = "Цвет границы вокруг выделенного элемента";
