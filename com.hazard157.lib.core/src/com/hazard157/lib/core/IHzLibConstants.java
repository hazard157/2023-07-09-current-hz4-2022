...
public interface IHzLibConstants {
  ...
  String ICON_ZS_ARIES             = "zs-aries";            //$NON-NLS-1$
  String ICON_ZS_TAURUS            = "zs-taurus";           //$NON-NLS-1$
  String ICON_ZS_GEMINI            = "zs-gemini";           //$NON-NLS-1$
  String ICON_ZS_CANCER            = "zs-cancer";           //$NON-NLS-1$
  String ICON_ZS_LEO               = "zs-leo";              //$NON-NLS-1$
  String ICON_ZS_VIRGO             = "zs-virgo";            //$NON-NLS-1$
  String ICON_ZS_LIBRA             = "zs-libra";            //$NON-NLS-1$
  String ICON_ZS_SCORPIO           = "zs-sciorpio";         //$NON-NLS-1$
  String ICON_ZS_SAGITTARIUS       = "zs-sagittarius";      //$NON-NLS-1$
  String ICON_ZS_CAPRICORN         = "zs-capricorn";        //$NON-NLS-1$
  String ICON_ZS_AQUARIUS          = "zs-aquarius";         //$NON-NLS-1$
  String ICON_ZS_PISCES            = "zs-pisces";           //$NON-NLS-1$
