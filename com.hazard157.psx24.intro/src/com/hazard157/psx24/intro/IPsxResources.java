...
interface IPsxResources {
  ...
  String STR_N_INTRO_THUMB_SIZE     = "Welcome thumb";
  String STR_D_INTRO_THUMB_SIZE     = "Welcome screen episode thumbs size";
  String STR_N_INTRO_LABEL_AS_YMD   = "Label as 'YYYY-MM_DD'";
