...
public class TsNodeTreeTagLeaf
   ...
   */
  public static final String KIND_ID = "TagLeaf"; //$NON-NLS-1$
   ...
   */
  public TsNodeTreeTagLeaf( ITsNode aParent, ITagLine aTagLine, ITag aEntity ) {
  ...
  protected IList<ITsNode> doGetNodes() {
    ...
    for( Secint in : tagline.marks( entity().id() ).values() ) {
      ITsNode n = new TsNodeTreeTagInterval( this, entity(), in );
      nodes.add( n );
    }
    return nodes;
  }
