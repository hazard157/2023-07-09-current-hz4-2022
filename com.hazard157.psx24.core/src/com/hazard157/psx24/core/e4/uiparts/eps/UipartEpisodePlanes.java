...
public class UipartEpisodePlanes
  ...
  private final ITsSelectionChangeListener<MarkPlaneGuide> guideSelectionListener = ( aSource, aSelectedItem ) -> {
  ...
  IM5Model<MarkPlaneGuide>           model;
  IM5CollectionPanel<MarkPlaneGuide> panel;
  ...
  protected void doSetEpisode() {
    ...
    IM5LifecycleManager<MarkPlaneGuide> lm = model.getLifecycleManager( episode().planesLine() );
