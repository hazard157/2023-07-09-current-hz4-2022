...
public class SourceVideoM5Model
   ...
   */
  public static final String MODEL_ID = "psx.ISourceVideo"; //$NON-NLS-1$

  /**
   * Идентификатор поля {@link #LOCATION}.
   */
  public static final String FID_LOCATION = "Location"; //$NON-NLS-1$
  ...
  public SourceVideoM5Model() {
    super( MODEL_ID, ISourceVideo.class );
